...
public class TextEditor implements ActionListener,WindowListener{
    ...
    TextEditor()
    {
        ...
        Image icon = Toolkit.getDefaultToolkit().getImage("F:\\2nd semester course\\JavaApplication\\Resources\\notepad.png");   
        ...
        file.add(New);
        New.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\neww.png"));
        ...
        open.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\open.png"));
        ...
        save.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\save.png"));
        ...
        saveas.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\save.png"));
        ...
        exit.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\exit.png"));
        ...
        edit.add(cut);
        cut.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\cut.png"));
        ...
        copy.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\copy.png"));
        ...
        delete.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\delete.png"));
        ...
        paste.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\paste.png"));
        ...
        clear.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\clear.png"));
        ...
        select.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\select.png"));
        ...
        wordwrap.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\wordwrap.png"));
        ...
        zoom_in.setMnemonic(KeyEvent.VK_I);
        zoom_in.setAccelerator(KeyStroke.getKeyStroke('I', InputEvent.CTRL_MASK, true));
        view.add(zoom_in);
        ...
        zoom_in.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\zoom_in.png"));
        
        zoom_out = new JMenuItem("Zoom-Out");
        zoom_out.setMnemonic(KeyEvent.VK_O);
        zoom_out.setAccelerator(KeyStroke.getKeyStroke('O', InputEvent.CTRL_MASK, true));
        view.add(zoom_out);
        ...
        zoom_out.add(new JSeparator());
        zoom_out.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\zoom_out.png"));
        
        normal = new JMenuItem("Default Screen");
        normal.setMnemonic(KeyEvent.VK_N);
        normal.setAccelerator(KeyStroke.getKeyStroke('N', InputEvent.CTRL_MASK, true));
        view.add(normal);
        ...
        normal.add(new JSeparator());
        normal.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\normal.png"));
        ...
        format.add(font);
        font.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\font.png"));
        ...
        font_color.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\font_color.png"));
        ...
        background_color.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\background_color.png"));
       ...
       jmenubar.add(search);
        ...
        search.add(find);
        find.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\find.png"));
        ...
        search.add(replace);
        replace.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\replace.png"));
        ...
        lighttheme.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\theme.png"));
        ...
        theme.add(darktheme);
        darktheme.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\theme.png"));
        ...
        Help.add(about);
        about.setIcon(new ImageIcon("F:\\2nd semester course\\JavaApplication\\Resources\\about.png"));
